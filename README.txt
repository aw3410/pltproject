...
below and goes to an error state which returns an error message. Upon processing the first lexical error, it will gracefully exit the program with an  error message that states the error and the position in which the error occurs. 
