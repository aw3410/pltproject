...
The output.py files contain the output of running each of our sample programs. We provided this as an intermediate
to show the result of code generation, before executing that code itself. These output files are generated by 
running our shell script commands.
